...
class QuestionAdmin(admin.ModelAdmin):
    ...
    fields = ('name', 'comms', 'eng', 'not_blank', 'with_vars', 'multi_vars')
    search_fields = ['name',]
    save_as = True
...
class FormAdmin(admin.ModelAdmin):
    ...
    fieldsets = [ ( None, { 'fields': [ 'name', 'name_eng' ] } ), 
	             ( 'Info', { 'fields': [ 'full_name', 'full_name_eng', 'theme', 'user_theme', 'help_info', 'clarification', 'clarification_eng', 'info', 'info_eng' ], 'classes': [ 'collapse' ] } ), ( None, { 'fields': [ 'not_reversed' ] } ), ( None, { 'fields': [ 'is_active' ] } ), ( None, { 'fields': [ 'start_time' ] } ), ( None, { 'fields': [ 'finish_time' ] } ), ( 'Access', { 'fields': [ 'aif', 'unaif', 'aifpass', 'aifres' ], 'classes': [ 'collapse' ] } ), ( 'Files', { 'fields': [ 'file', 'result', 'default_list', 'test_answers' ], 'classes': [ 'collapse' ] } ), ( 'Permission', { 'fields': [ 'owner', 'editor', 'reader' ], 'classes': [ 'collapse' ] } )]
